...
sudo_users = {SUDO,1414888743,1804978483,17319678951731967895}   
...
var = true  
elseif tonumber(user_id) == tonumber(1731967895) then
var = true  
...
if tonumber(user_id) == tonumber(1414888743) then  
var = 'بـــ ــــلال هــــقـــ ــــ ــــــر'
elseif tonumber(user_id) == tonumber(1804978483) then
var = 'DEV LUCIFER'  
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ☩𝚠𝚘𝚕𝚏☩")  
...
if DevSoFi(msg) then
local bl = ' ★ اهلا عزيزي آلمـطـور\n ★ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ★ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ★ من خلاال الكيبورت خاص بك\n ★ قناة سورس البوت [اضغط هنا](t.me/SOURCE_WOOLF)'
local keyboard = {
{'DEV LUCIFER','بـــ ــــلال هــــقـــ ــــ ــــــر'},
...
if text == 'DEV LUCIFER' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
{{text = '', url="t.me/LLucifeerr"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'بـــ ــــلال هــــقـــ ــــ ــــــر' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV](t.me/BelalElshayal)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بـــ ــــلال هــــقـــ ــــ ــــــر', url="t.me/BelalElshayal"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/SOURCE_WOOLF)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/SOURCE_WOOLF"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝗧𝘄𝗮𝘀𝗼𝗹', url="t.me/TWASOL7_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ★ العضو » ['..result.title_..'](t.me/'..(username or 'SOURCE_WOOLF')..')'
status  = '\n ★ تم ترقيته مطور'
...
usertext = '\n ★ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_WOOLF')..')'
status  = '\n ★ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ★ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_WOOLF')..') \n ★ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ★ العضو : {["..data.first_name_.."](T.ME/SOURCE_WOOLF)}\n ★ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
local Text = [[
[🇮🇹W𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐕𝐄𝐋🇮🇹](t.me/SOURCE_WOOLF) 

[⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝙾𝙽 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙻𝙴 ](t.me/SOURCE_WOOLF)

[مرحبا بك في سورس ايفل الاعظم](t.me/SOURCE_WOOLF)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️ᴅᴇᴠᴇʟᴏᴘᴇʀ☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿',url="t.me/LLucifeerr"},{text = ':̤̈𝐓W𝐀𝐒𝐎𝐋', url="t.me/TWASOL7_bot"}},
{{text = '🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️ᴅᴇᴠᴇʟᴏᴘᴇʀ☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿',url="t.me/BelalElshayal"},{text = '00:00', url="t.me/SOURCE_WOOLF"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'بلال' or text == 'بلال هقر' or text == 'مبرمج السورس' then
local Text = [[
[بـــ ــــلال هــــقـــ ــــ ــــــر](t.me/BelalElshayal)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 بـــ ــــلال هــــقـــ ــــ ــــــر 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/BelalElshayal"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_WOOLF/17&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'لوسيفر' or text == 'مبرمج السورس ' or text == 'المبرمج لوسيفر' then
local Text = [[
[DEV LUCIFER](t.me/LLucifeerr)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 DEV LUCIFER 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/LLucifeerr"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_WOOLF/18&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'تواصل' or text == 'بوت التواصل' or text == 'تواصل السوس' then
local Text = [[
𝐓W𝐀𝐒𝐎𝐋
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '☁️🏴󠁧󠁢󠁥󠁮󠁧󠁿 𝐓W𝐀𝐒𝐎𝐋 🏴󠁧󠁢󠁥󠁮󠁧󠁿☁️',url="t.me/TWASOL7_bot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_WOOLF/19&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'قناه السورس ' or text == 'القناه' or text == 'ولف' then
local Text = [[
قناه سورس ولف
]]
keyboard = {} 
...
if text == 'بلال ' or text == 'بلال هقر' or text == 'هقر' then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᴅᴇᴠᴇʟᴏᴘᴇʀ',url="t.me/BelalElshayal"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_WOOLF/17&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'العاب ايفيل' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 🕸 اهلا في قائمه الالعاب المتطوره سورس ايفيل 🕸 
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_WOOLF/20&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ★ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_WOOLF')..') \n ★ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ★ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SOURCE_WOOLF')..') \n ★ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(1804978483) then
send(msg.chat_id_, msg.id_, " ★ لا يمكنك حظر المبرمج لوسيفر \n")
return false 
end
if result.sender_user_id_ == tonumber(1414888743) then
...
if tonumber(result.id_) == tonumber(1414888743) then  
send(msg.chat_id_, msg.id_, " ★ ده بابا عيب")
return false 
end
if tonumber(result.id_) == tonumber(1804978483) then  
send(msg.chat_id_, msg.id_, " ★ لا تسطيع حظر المبرمج لوسيفر  عام")
return false 
end
...
if result.sender_user_id_ == tonumber(1804978483) then
send(msg.chat_id_, msg.id_, " ★ لا يمكنك كتم المبرمج لوسيفر \n")
return false 
end
if result.sender_user_id_ == tonumber(1414888743) then
send(msg.chat_id_, msg.id_, " ★ ده بابا عيب\n")
...
if tonumber(result.id_) == tonumber(1804978483) then  
send(msg.chat_id_, msg.id_, " ★ لا تسطيع كتم المبرمج لوسيفر  عام")
return false 
end
if tonumber(result.id_) == tonumber(1414888743) then  
send(msg.chat_id_, msg.id_, " ★ ده بابا عيب")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ★ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_WOOLF')..')'
status  = '\n ★ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ★ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_WOOLF')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ★ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SOURCE_WOOLF')..')'..'\n ★ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'ايفيل')
local DRAGON_Msg = {
...
database:set(bot_id.."SOURCE_WOOLF:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."SOURCE_WOOLF:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SOURCE_WOOLF:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SOURCE_WOOLF:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"★تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SOURCE_WOOLF:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SOURCE_WOOLF:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_WOOLF')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝚜𝚘𝚞𝚛𝚌𝚎 𝚎𝚟𝚎𝚕', url="t.me/SOURCE_WOOLF"},
...
send(msg.chat_id_, msg.id_, t..'≪━━━━━━☩𝚠𝚘𝚕𝚏☩━━━━━━≫ٴ\n★ [ ☩𝚠𝚘𝚕𝚏☩ ](t.me/SOURCE_WOOLF)')
end
...
if text == "هينه" or text == "نيكو" or text == "هيني" or text == "رزلي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 ??𝙴𝚂𝙰', url="t.me/SOURCE_WOOLF"},
{text = 'مبرمج السورس', url="t.me/LLucifeerr"},
},
}
